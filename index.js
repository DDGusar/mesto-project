...
profileEditBtn.addEventListener('click', function(){openForm(profilePopup)});
profileAddBtn.addEventListener('click', function(){openForm(cardPopup)});
profileCloseBtn.addEventListener('click', function(){closeForm(profilePopup)});
cardCloseBtn.addEventListener('click', function(){closeForm(cardPopup)});
imageCloseBtn.addEventListener('click', function(){closeForm(imagePopup)});
formElement.addEventListener('submit', handleProfileFormSubmit);
formCard.addEventListener('submit',createCardForm );
